...
from sklearn.metrics import log_loss   # FIX: was brier_score_loss — NLL is correct for calibration
...
class TemperatureScaler:
    ...
    def fit(self, probs: np.ndarray, labels: np.ndarray) -> "TemperatureScaler":
        ...
        def nll(T):
            ...
            return log_loss(labels, calibrated)   # FIX: NLL minimization → correct T
